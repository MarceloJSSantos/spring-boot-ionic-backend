...
public class Endereco implements Serializable{
	...
	@ManyToOne
	@JoinColumn(name="cidade_id") // este é o nome do campo que será criado no BD
	private Cidade cidade; //só o endereço conhece a cidade, cidade não conhece o endereço
	
	//construtores
	public Endereco() {
	}

	public Endereco(Integer id, String logradouro, String numero, String complemneto, String bairro, String cep,
